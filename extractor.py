...
def build_classified_passage(
    ...
    return ClassifiedPassage(
        ...
        category=stage_b.get("category", ""),
        subcategory=stage_b.get("subcategory", ""),
        seed_category=bool(stage_b.get("seed_category", False)),
        iro_type=stage_b.get("iro_type", "not_specified"),
        value_chain_position=stage_b.get("value_chain_position", "not_specified"),
        evidence_quality=stage_b.get("evidence_quality", "anecdotal"),
        time_horizon=stage_b.get("time_horizon", "unspecified"),
        ...
        confidence_rationale=stage_b.get("confidence_rationale", ""),
